...
namespace Pumped\UserBundle\Controller;

use Pumped\UserBundle\FOSUserEvents;
use Pumped\UserBundle\Event\FormEvent;
use Pumped\UserBundle\Event\GetResponseUserEvent;
use Pumped\UserBundle\Event\FilterUserResponseEvent;
use Pumped\UserBundle\Model\UserInterface;
...
class ResettingController extends ContainerAware
{
     ...
     *
     * @param \Pumped\UserBundle\Model\UserInterface $user
     *
     * @return string
     */
