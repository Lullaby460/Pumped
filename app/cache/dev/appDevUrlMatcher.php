...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            // pumped_pumped_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'pumped_pumped_homepage')), array (  '_controller' => 'Pumped\\PumpedBundle\\Controller\\DefaultController::indexAction',));
            }

            // HelloTheWorld
            if ($pathinfo === '/hello-world') {
                return array (  '_controller' => 'Pumped\\PumpedBundle\\Controller\\DefaultController::indexAction',  '_route' => 'HelloTheWorld',);
            }

            // pumped_calendar_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
